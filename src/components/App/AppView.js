...
import Operations from '../Operations';       // координаты обработок
import Otliv from '../Otliv';                 // рендер без особенностей
      ...
      return (
        <div style={dstyle}>
          <Switch>
            ...
            <Route path="/operations" render={(props) => wraper(Operations, props)}/>
