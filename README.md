...
## Философия решения
Библиотека paperless.js построена на базе [metadata.js](../metadata.js), но metadata.js использована в безбумажке нетрадиционным способом:
- Таблицы данных на стороне браузера, описание метаданных и динамические форы в настоящий момент не используются
